...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Caption.}
    %\caption{\centering Se observan las curvas para la función de costo y accuracy durante el entrenamiento, tanto para los datos de validación como para los de test. Se observa que aproximadamente a partir de la época 2000, la red comienza a presentar overfitting, disminuyendo su capacidad de generalización frente a datos con los cuales no es entrenada.}
    \label{PONER_LABEL}
\end{figure}
